...
const TABS = [
  ...
  },
  {
    ...
    desc: "Spot repeated topics, trends and likely questions across years",
  },
  {
    id: "pqquiz",
...
function HomeInner() {
  const [tab, setTab] = useState<"notes" | "analyzer" | "pqquiz">("notes");
  ...
  // Register service worker (only prod + https)
  useEffect(() => {
    if (
  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative" }}>
      ...
      <Navbar
        defaultAuthMode={searchParams.get("mode") as "signin" | "signup" | undefined}
      />
      ...
      >
        ...
        {!isLoggedIn && !loading && (
          ...
          >
            ...
            >
              Sign in or continue as guest to start using Studiengine.
            </p>
        ...
        {/* Tools card */}
        <div className="glass" style={{ borderRadius: 18, padding: "24px 20px" }}>
          {isLoggedIn ? (
            <>
            ...
            <div style={{ textAlign: "center", padding: "40px 20px" }}>
              ...
              >
                Notes to CBT, PQ Analyzer, and PQ to CBT — all in one place.
              </p>
              <button
                onClick={() => setShowAuth(true)}
                className="btn-primary"
