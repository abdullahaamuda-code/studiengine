  ...
  return (
    <div
      style={{
        ...
        borderRadius: "50%",
        background:
          "radial-gradient(circle at 30% 30%, rgba(59,130,246,0.15), rgba(8,145,178,0.05))",
...
const FEATURES = [
  {
    icon: "📝",
    title: "Notes → CBT",
    desc: "Paste lecture notes or upload a PDF. Get instant MCQ practice questions from your own material.",
  },
  {
    icon: "🔍",
    title: "PQ Analyzer",
    desc: "Upload past questions. Discover hot topics, repeated patterns, and what's likely to appear.",
  },
  {
    icon: "⚡",
    title: "PQ → CBT",
    desc: "Turn any past question paper into an interactive CBT with answers and full explanations.",
  },
  {
    icon: "🤖",
    title: "AI Explanations",
    desc: "Stuck on a question? Ask the AI — get a step-by-step breakdown in plain language.",
  },
  {
    icon: "🧮",
    title: "Scientific Calculator",
    desc: "Built-in calculator for math and science questions. No switching tabs.",
  },
  {
    icon: "📊",
    title: "Track History",
    desc: "Premium users see all past CBT sessions, scores, and can review every question again.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "Your lecture notes, past questions, or any study material",
  },
  {
    n: "2",
    title: "AI generates CBT",
    desc: "Instant multiple-choice questions with A B C D options",
  },
  {
    n: "3",
    title: "Practice & review",
    desc: "See your score, review mistakes, understand every answer",
  },
];
...
const SAMPLE_QS = [
  {
    ...
    opts: [
      {
        l: "A",
        t: "Movement of water through a semi-permeable membrane from low to high solute concentration",
        correct: true,
      },
      {
        l: "B",
        t: "Movement of solutes from low to high concentration",
        correct: false,
      },
      {
        l: "C",
        t: "Active transport of ions across cell membranes",
        correct: false,
      },
      {
        l: "D",
        t: "Diffusion of gases through a permeable membrane",
        correct: false,
      },
    ],
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            >
              {/* NOTE: On mobile, we effectively remove the Sign In button by only showing it on larger screens if you later add classes or logic.
                  For now, you asked to remove it entirely from the navbar UI, so it's commented out. */}
            ...
            >
              ...
              <h1
                style={{
                  ...
                  marginBottom: 14,
                  background:
                    "linear-gradient(135deg,#e8f0fe 0%,#60a5fa 50%,#22d3ee 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
...
Paste your study material and get instant multiple-choice questions with answers and explanations — plus trends from your past questions so you know what to focus on.
              ...
              <FadeIn>
                <div
                  style={{
                    ...
                    padding: 16,
                    boxShadow:
                      "0 18px 45px rgba(15,23,42,0.8), 0 0 0 1px rgba(15,23,42,1)",
                ...
                >
                  ...
                  <div
                    style={{
                      background:
                        "linear-gradient(135deg,rgba(37,99,235,0.4),rgba(8,145,178,0.25))",
                      borderRadius: 14,
                      padding: 10,
                      marginBottom: 12,
                    }}
                  >
                    ...
                    >
                      “Topic: Cell biology lecture note (3 pages)”
                    </div>
                  </div>
                    ...
                    {["A", "B", "C", "D"].map((l, i) => (
                      <div
                        ...
                        style={{
                          ...
                          fontSize: 11,
                          color:
                            i === 2 ? "#bbf7d0" : "rgba(148,163,184,0.9)",
                          display: "flex",
                          alignItems: "center",
                          gap: 6,
                        }}
                      >
                        <span
                          style={{
                            ...
                            fontSize: 9,
                            fontWeight: 700,
                            color: i === 2 ? "#022c22" : "#64748b",
                          }}
                        >
                          {i === 2 ? "✓" : l}
                        </span>
                        <span>
                          Option {l} answer text from your own material
                        </span>
                      </div>
                    ))}
                  </div>
                  ...
                  >
                    AI explanation shows why the correct option is right and
                    others are wrong — so you actually understand, not just cram.
                  </div>
                </div>
              </FadeIn>
            </div>
                ...
                >
                  <span
                    style={{
                      ...
                      fontWeight: 700,
                      background:
                        answered !== null && o.correct
                          ? "rgba(22,163,74,0.3)"
                          : answered === i && !o.correct
                          ? "rgba(239,68,68,0.2)"
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 12,
                      background:
                        "linear-gradient(135deg,rgba(37,99,235,0.25),rgba(8,145,178,0.15))",
                      border: "1px solid rgba(59,130,246,0.2)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
        ...
        >
          <FadeIn>
            ...
            >
              Built for how Nigerian students actually study
            </p>
          </FadeIn>
          <div
            style={{
        ...
        >
          <FadeIn>
            ...
            >
              Works for all Nigerian exams and beyond
            </p>
            <div
              style={{
                display: "flex",
        ...
        <footer
          style={{
            borderTop: "1px solid rgba(56,139,253,0.06)",
            padding: "18px 24px",
            textAlign: "center",
          }}
        >
          ...
          >
            © 2025 Studiengine · Built for Nigerian students
          </p>
        </footer>
      </div>
    </div>
