...
export default function AIAssistant() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hey! I'm your Studiengine admin assistant. Ask me anything about your users, stats, or how to manage the platform.",
    },
  ]);
  ...
  async function fetchContext(): Promise<string> {
    try {
      ...
      return `Stats: ${total} users (${guests} guests, ${
        total - guests
      } registered, ${premium} premium). ${todayCBTs} CBTs today.`;
    } catch {
      return "Could not fetch live stats.";
    }
  }
      ...
      const res = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are the admin AI for Studiengine, a Nigerian student CBT exam prep app. Be concise and practical. Live data: ${context}`,
            },
    ...
    setMessages([
      {
        role: "assistant",
        content:
          "Chat cleared. I'm still here to help with your admin tasks whenever you're ready.",
      },
    ]);
      ...
      >
        ...
        >
          <div>
            ...
            >
              Ask about users, analytics, or platform management
            </p>
          </div>
          <button
            onClick={clearChat}
