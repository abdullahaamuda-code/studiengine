...
export default function UpgradeModal({ onClose, reason }: Props) {
  ...
  function handlePayment() {
    ...
    const message = `Hi, I want to upgrade my Studiengine account (${email}) to Premium. Please help me activate it.`;
    const url = `https://wa.me/2348169936326?text=${encodeURIComponent(
      message
    )}`;

    alert(
      "Payment coming soon! We're setting up Paystack.\n\nFor now, we'll open WhatsApp so you can message us to manually activate Premium."
    );
      ...
      >
        ...
        >
          ...
          {reason ? (
            ...
            <p style={{ fontSize: 13, color: "#475569", margin: 0 }}>
              Unlock the full Studiengine experience
            </p>
          )}
        </div>
        ...
        <div style={{ padding: "20px 24px" }}>
          ...
          <div
            style={{
              background:
                "linear-gradient(135deg,rgba(37,99,235,0.08),rgba(8,145,178,0.05))",
